        ...
        <div class="col-md-12">
            <div class="card mb-3">
                    ...
                    <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="<?= base_url("cart/delete/$row->id") ?>" method="POST">
                                            <input type="hidden" name="id" value="<?= $row->id ?>">
                                            <button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure?')"><b>Hapus</b></button>
                                        </form>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th class="text-center"><strong>Rp.<?= number_format(array_sum(array_column($content, 'subtotal')), 0, ',', '.') ?>,-</strong></th>
                                <th></th>
                            </tr>
                        </tfoot>
                    </table>
                ...
                <div class="card-footer">
                    <a href="<?= base_url('checkout') ?>" class="btn btn-success float-right text-white"> Checkout <i class="fas fa-angle-right"></i></a>
