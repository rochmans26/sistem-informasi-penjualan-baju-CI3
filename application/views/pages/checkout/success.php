        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ol>
                        <li>Lakukan pembayaran pada rekening <strong>BRI 123456789012</strong> a/n PT.Fizzul Collection</li>
                    ...
                    <a href="<?= base_url('home') ?>" class="btn btn-dark"><i class="fas fa-angle-left"></i> Kembali</a>
                </div>
            </div>
        </div>
    </div>
